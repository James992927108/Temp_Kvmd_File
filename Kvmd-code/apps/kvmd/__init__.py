...
def main(argv: Optional[List[str]]=None) -> None:
    ...
    args_parser, remaining , config= init(
        prog="kvmd",
    ...
    logger.debug("call KvmdServer() class")
    kvmd_service = KvmdServer(
    ...
    kvmd_service.run(**config.server._unpack(ignore=["heartbeat", "sync_chunk_size"]))

    logger.debug("finish KvmdServer()")
